...
export const PLACEHLODER_TYPES = {
  fullname: "နာမည်ကို ပြည်စုံစွာ ဖြည်သွင်းပါ၊",
  email: "မှန်ကန်သော email လိပ်စာဖြည့်ပါ",
  universityId: "ကိုယ်ပိုင် နံပါတ်ကို ဖြည့်သွင်းပါ၊",
